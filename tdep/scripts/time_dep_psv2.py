...
ana = cy.get_analysis(cy.selections.repo, 'version-002-p03', cy.selections.PSDataSpecs.ps_10yr_separate[-6:-3])
...
if nevts!=0.:
    np.save('/data/user/wluszczak/KDE_csky/sigtrials/psv2/ps_v2_%s_%s_%s_%s_%s.npy'%(nevts, gamma, t0, dt, inputseed), multiple_trials)

else:
    np.save('/data/user/wluszczak/KDE_csky/bgtrials/psv2/psv2_bg_flares_%s.npy'%(inputseed), multiple_trials)
